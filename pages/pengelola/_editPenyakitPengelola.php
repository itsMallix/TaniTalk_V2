...
<body>
    ...
    <table border="1" width="50%">
        <?php
            echo "<tr><th>No</th><th>Nama Penyakit</th><th>Jenis Penyakit</th><th>Deskripsi</th><th>Gambar</th><th>Aksi</th></tr>";
            while($row = mysqli_fetch_assoc($hasil)){
                ...
                <tr>
                    ...
                    <td>$row[gambar]</td>
                    <td>
                    <a href='../../controller/hapusPenyakit.php?id=$row[id]' 
                        onClick=\"
                            if(confirm('Apakah Anda yakin ingin menghapus data ini?'))
                                {window.location.href = '_hapusBudidayaPengelola.php'}
                            else{return false;}\">Hapus</a>
                    <a href='_showEditPenyakit.php?id=$row[id]'>EDIT</a>
                    </td>
                    ";
                }
                ?>
